...
- Plot tests use **pytest-mpl** with baselines pinned to **matplotlib==3.11.2** (hard pin in `pyproject.toml`). Regenerating baselines on another version = false failures. See the `test` skill.

...
- TestInitialization: Object creation and basic setup
- TestAttributes: Direct attribute access (segments, best, summary, df, df_summary)
- TestSetBest: Best trend identification
- TestSetSummary: Summary statistics generation
- TestSetDataFrame: DataFrame conversion methods
- TestFilterSegments: Filtering and sorting functionality
- TestPrintSummary: Output generation
- TestIntegration: Full workflow and edge cases
...
class TestPyTrendyResults:
    ...
    # =============================================================================
    # Helper Methods (shared across all test classes)
    # =============================================================================

    @pytest.fixture
    def gradual_results(self):
        """

...
- zero_baseline_edgecases.csv: zero-baseline market entry series (new-market launch scenario) that broke abrupt padding — the entire series collapsed to Flat when `abrupt_padding` was set (fixed in v1.2.4, PR #142). Columns: `zero_baseline_market_entry_1` (original), `zero_baseline_market_entry_2` (20→195 ramp, issue #163), `zero_baseline_market_entry_3` (10→125 ramp, issue #163).

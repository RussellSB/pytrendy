...
- issue_163_zero_baseline_edgecases.csv: zero-baseline market entry series that produced false Noise segments at the leading edge of abrupt transitions (issue #163, fixed in PR #164). Columns: `zero_baseline_market_entry_2` (20→195 ramp), `zero_baseline_market_entry_3` (10→125 ramp).
